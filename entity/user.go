...
type User struct {
	...
	Title     string    `json:"title" gorm:"type:varchar(50);default:null"`
	...
	ClassMentors    []ClassMentor   `gorm:"foreignKey:UserID"`
	EnrolledClasses []EnrolledClass `gorm:"foreignKey:UserID"`
